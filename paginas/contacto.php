...
<!-- Contacto -->
		<header class="jumbotron" style="background: lightgreen;">
      		...
      		<p class="text-center">
      		Si estás interesado, no dudes en mandarme un correo y empecemos a hacer negocios 
      		<i class="fa fa-thumbs-up fa-1x " aria-hidden="true"></i>.
      		</p>

      			<div class="col-md-6 col-xs-12">
					<p id=" header" class="text-center align-middle"><i class="fa fa-envelope fa-2x" aria-hidden="true"></i>&nbsp; &nbsp; info@rippleylegacy.com.ve</p>
      			</div>
      			<div class="col-md-6 col-xs-12">
					<p class="text-center"><i class="fa fa-mobile fa-3x " aria-hidden="true"></i>&nbsp; &nbsp; +58 424 - 2482023</p>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<button class="btn btn-info btn-lg btn-block" data-toggle="collapse" data-target="#formulario_cont">
...
<fieldset> 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-offset-2 col-sm-8">
      		...
      		<button type="submit" class="btn btn-info btn-block btn-lg"> Enviar <span class="glyphicon"></span></button>
